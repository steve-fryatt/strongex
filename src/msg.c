...
static struct msg_data msg_messages[] = {
	...
	{MSG_VERBOSE,	"Directory '%s'; size of %d bytes in directory entry and %d bytes in directory block (of which %d bytes used)"},
	{MSG_VERBOSE,	"File '%s' of type 0x%x; size of %d bytes"},
	{MSG_WARNING,	"File '%s' of type 0x%x; size of %d bytes in directory entry, but %d bytes in file block"},
	{MSG_VERBOSE,	"Empty file '%s' of type 0x%x, with no directory record"},
	{MSG_WARNING,	"Empty file '%s' of type 0x%x, with no directory record but size of %d bytes"},
	{MSG_WARNING,	"Directory '%s' has object attributes 0x%x"},
	{MSG_WARNING,	"File '%s' has object attributes 0x%x"},
